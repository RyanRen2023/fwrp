...
import com.algonquin.cst8288.fwrps.service.UserService;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "create":
                ...
                break;
            case "update":
                userService.updateUser(userId, username, password, email, role);
            ...
            case "validate":
                ...
                out.println("Password valid: " + isValid);
                break;
            default:
